                    ...
                    <div class="flex">
                        <div class="flex-1 flex flex-col gap-5">
                            <div class="flex gap-2 items-center">
                                ...
                                <div class="flex-1">
                                    <input disabled type="text" name="first_name" id="first_name" class="laptop:text-xs desktop:text-sm w-full outline-none caret-[#00B0F0] pl-2 py-[.3rem] focus:ring-1 bg-gray-100 text-sm" value="{{ $user->first_name }}" placeholder="Optional">
                                    @error('first_name')
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <div class="flex-1"><input type="text" disabled name="last_name" class="laptop:text-xs desktop:text-sm w-full outline-none caret-[#00B0F0] pl-2 py-[.3rem] focus:ring-1 bg-gray-100 text-sm" value="{{ $user->last_name }}" placeholder="Optional"></div>
                            </div>
                            <div class="flex gap-2 items-center">
                                <div class="flex-1 text-end laptop:text-xs desktop:text-sm"><label for="middle_name">Middle Name</label></div>
                                <div class="flex-1"><input type="text" disabled name="middle_name" class="laptop:text-xs desktop:text-sm w-full outline-none caret-[#00B0F0] pl-2 py-[.3rem] focus:ring-1 bg-gray-100 text-sm" value="{{ $user->middle_name }}" placeholder="Optional"></div>
                            </div>
                        </div>
                        ...
                        <div class="flex-1 flex flex-col gap-5 mr-32">
                            <div class="flex gap-2 items-center">
                                ...
                                <div class="flex-1" >
                                    <select disabled name="gender" class="laptop:text-xs desktop:text-sm w-full outline-none caret-[#00B0F0] pl-2 py-[.3rem] focus:ring-1 bg-gray-100 text-sm">
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <div class="flex-1"><input type="text" disabled name="email" class="laptop:text-xs desktop:text-sm w-full outline-none caret-[#00B0F0] pl-2 py-[.3rem] focus:ring-1 bg-gray-100 text-sm " value="{{ $user->email }}"></div>
                            </div>
                        </div>
                    </div>
