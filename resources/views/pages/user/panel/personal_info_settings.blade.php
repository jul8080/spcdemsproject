    ...
    <div class="desktop:w-[1000px] h-[500px] rounded-md flex flex-col gap-2">
        ...
        <div class="flex-1 flex items-center justify-center border-t-[1px] z-10 relative">
            ...
            <div class="w-full h-full flex flex-col">
                ...
                <form id="form_submit" action="{{ route('user.personal.info') }}" method="POST" class="flex justify-center flex-col flex-1 gap-5 p-10">
                    @csrf
                    <div class="flex">
                    ...
                    <div class="w-full flex items-center justify-between h-[50px] border-t-[1px]">
                        ...
                        <button id="showSaveBtn" class="hidden btn text-white font-bold text-xs focus:ring-1 bg-[#00B0F0] py-2 rounded-md hover:bg-[#00B0F0]/80">Save changes</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    $('#edit-info').click(function (e) {
     ...
     $('#cancel-edit').click(function (e) {
         ...
         $('#cancel-edit').hide();
         $('#edit-info').show();
         $('form input, select').attr('disabled', 'disabled');$('form input, select').attr('disabled', 'disabled');
     });
 </script>
@endsection
