    ...
    <div class="h-full w-full p-3">
        <div class="h-full flex flex-col">
            <div class="flex items-center justify-between h-28 relative">
                ...
                {{-- <a href="{{ route('admin.create.employee') }}" class="btn btn-border rounded-md">+ Add Employee</a> --}}
            </div>

            <div class="w-full flex-1 flex gap-2">

                <div class=" flex-1">
                    <div class="h-44 flex gap-2">
                ...
                {{-- employee search  --}}
                <div class="h-[620px] w-72 overflow-y-auto self-end flex flex-col gap-2 border-[1px]" id="search-scrollbar">
                    <div class="w-full h-20 flex items-center px-2 flex-shrink-0 border-b-[1px]">
                        <form action="{{ url('/admin/search/user') }}" method="GET" class="h-10 flex w-full items-center">
                            @csrf
                            <button type="submit" class="w-12 flex items-center justify-center bg-[#00B0F0] h-full border border-[#00B0F0]">
