                    ...
                    <form action="{{ route('admin.password.change') }}" method="POST" class="flex items-center justify-center flex-col flex-1 gap-5 p-10">
                        ...
                        <div class="flex w-full gap-1">
                            <div class="flex-1 flex items-center justify-end">
                                <label  class="text-gray-500 font-semibold laptop:text-xs desktop:text-sm">Current password</label>
                            </div>
                            <div class="flex-1 flex items-center gap-2">
                                <input type="password" name="current_password" class="laptop:text-xs desktop:text-sm flex-shrink-0 w-full outline-none caret-[#00B0F0] py-1 pl-2 focus:ring-1 bg-gray-50">
                        ...
                        <div class="flex w-full gap-1">
                            <div class="flex-1 flex items-center justify-end">
                                <label  class="text-gray-500 font-semibold laptop:text-xs desktop:text-sm">New password</label>
                            </div>
                            <div class="flex-1 flex items-center gap-2">
                                <input type="password" name="password" class="laptop:text-xs desktop:text-sm flex-shrink-0 w-full outline-none caret-[#00B0F0] py-1 pl-2 focus:ring-1 bg-gray-50">
                                @error('password')
                                <span class="text-xs text-red-400 flex-shrink-0">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="flex w-full gap-1">
                            <div class="flex-1 flex items-center justify-end">
                                <label  class="text-gray-500 font-semibold laptop:text-xs desktop:text-sm">Confirmed password</label>
                            </div>
                            <div class="flex-1 flex items-center gap-2">
                                <input type="password" name="password_confirmation" class="laptop:text-xs desktop:text-sm flex-shrink-0 w-full outline-none caret-[#00B0F0] py-1 pl-2 focus:ring-1 bg-gray-50">
