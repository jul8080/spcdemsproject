    ...
    <div class="flex gap-2">
        <ul class="flex-1 flex flex-col gap-5 mt-10">
            <li class="flex">
                ...
                <div class="flex-1 flex"><span class="capitalize text-gray-400">{{ Auth::user()->last_name }}, {{ Auth::user()->first_name }} {{ Auth::user()->middle_name }}</span></div>
            </li>
            ...
            <li class="flex">
                ...
                <div class="flex-1 flex"><span class="capitalize text-gray-400">{{ $personalInfo->phone_no ?? "" }}</span></div>
            </li>
            <li class="flex">
                <div class="flex-1 flex-shrink-0"><span class="text-gray-400">Address:</span></div>
                <div class="flex-1 flex"><span class="text-gray-400">{{ $personalInfo->address ?? "" }}</span></div>
            </li>
        </ul>
        <ul class="flex-1 flex flex-col gap-5 mt-10">
            ...
            <li class="flex">
                ...
                <div class="flex-1 flex"><span class="text-gray-400">{{ $personalInfo->dob ?? "" }}</span></div>
            </li>
            <li class="flex">
                <div class="flex-1 flex-shrink-0"><span class="text-gray-400">Birth Place:</span></div>
                <div class="flex-1 flex"><span class="text-gray-400">{{ $personalInfo->birth_place ?? "" }}</span></div>
            </li>
            <li class="flex">
                <div class="flex-1 flex-shrink-0"><span class="text-gray-400">Age:</span></div>
                <div class="flex-1 flex"><span class="text-gray-400">{{ $personalInfo->age ?? "" }}</span></div>
            </li>
            <li class="flex">
                <div class="flex-1 flex-shrink-0"><span class="text-gray-400">Status:</span></div>
                <div class="flex-1 flex"><span class="text-gray-400">{{ $personalInfo->status ?? "" }}</span></div>
            </li>
        </ul>
    </div>
</div>
